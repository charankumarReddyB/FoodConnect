          ...
          {mode === 'otp' ? (
            ...
            <>
              ...
              {cfg.backendRole !== 'ADMIN' ? (
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-3 mb-6 text-center text-xs font-medium text-amber-600 dark:text-amber-400">
                  🔐 Administrator Authentication Requires Password Verification (Google Sign-In Disabled)
                </div>
              )}
